...
: ${AMENT_CURRENT_PREFIX:="/wolvi/src/install/computation_zone"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/computation_zone/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/computation_zone/environment/path.sh"
