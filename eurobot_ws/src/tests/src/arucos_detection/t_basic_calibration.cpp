...
int main() {
    ...
    vector<String> images = getImages("/wolvi/src/tests/src/arucos_detection/assets/calibration_photos/*.png");
    ...
    // Load test image
    img = imread("/wolvi/src/tests/src/arucos_detection/assets/playmat_photos/photo_2.png");
    int h = img.rows;
    int w = img.cols;
    ...
    imwrite("/wolvi/src/tests/src/arucos_detection/assets/calibresult.png", dst);
