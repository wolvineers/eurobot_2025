...
def fourth_initialize_frame(canvas):
    ...
    canvas.tag_bind(img_back, "<Button-1>", lambda e: switch_frame(third_initialize_frame, True))
    ...
    txt_initialize = canvas.create_text(600, 350, text="Start Round", font=font_2, fill="White", anchor="center")
